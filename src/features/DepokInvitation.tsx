...
export default function DepokInvitation() {
	...
	return (
		<main className={`font-[Alice] overflow-x-hidden ${hasScrolled ? '' : 'overflow-y-hidden'}`}>
            ...
            font-[Alice]"
						...
						<p className="text-xl tracking-widest">DEPOK, 21 JUNI 2025</p>
					</div>
			...
			>
				...
				>
					...
					>
						<SaveTheDate
							link="https://calendar.google.com/calendar/u/0/r/eventedit?text=Pernikahan+Imam+%26+Nida&dates=20250621T020000Z/20250621T120000Z&details=Undangan+Pernikahan+Imam+Ade+Surya+%26+Umrotun+Nida+yang+Insya+Allah+akan+diselenggarakan+pada+Sabtu,+21+Juni+2025&location=https://maps.app.goo.gl/xsAKosptMPkSbd52A"
							eventName="Wedding"
							date={new Date("2025-06-21T11:00:00").valueOf()}
						/>
					</div>
				</div>
			</section>
					...
					>
						...
						>
							...
							<p className="text-md mb-5">
								Gegesik Kidul<br /> Kecamatan Gegesik,<br /> Kabupaten Cirebon, Jawa
								Barat
							</p>
						</div>
						...
						>
							...
							>
								...
								/>
								<p
									className="text-xl uppercase font-semibold absolute bottom-[28px]"
								>
									Ngunduh Mantu
								</p>
							</div>
							<p className="text-xl mb-2">21 Juni 2025</p>
							<p className="text-xl mb-3">11:00 - 17:00 WIB</p>
							<p className="text-md mb-5">
								Jl. Pitara Raya Gg. Pos <br />
								RT 05/19 No. 27 Kel. Pancoran Mas,<br />
								Kota Depok, Jawa Barat
							</p>
							<a
								className="inline-block ring-1 ring-[#915282] px-6 py-2 mx-auto rounded-2xl hover:bg-[#915282] w-fit hover:text-white z-10"
								href="https://maps.app.goo.gl/xsAKosptMPkSbd52A"
								target="_blank"
			...
			>
				...
				>
					<div className="max-w-lg" data-aos="fade-up">
						...
						<p className="text-lg font-semibold tracking-widest">Imam & Nida</p>
					</div>
				</div>
			</section>
